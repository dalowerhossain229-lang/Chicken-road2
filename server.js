...
// 🎯 ৪-স্তর অফিশিয়াল ওOdds মাল্টিপ্লায়ার সিঁড়ি ১ শতভাগ খাঁটি লক ফায়ার
...
// 💰 ১. ডাইস ৩ডি অবিকল গেটওয়ে অনুযায়ী লাইভ অ্যাকাউন্ট ব্যালেন্স ইন্টারсеপ্টর ಗೆಟ್ವೇ
...
app.post('/api/chicken-jump', async (req, res) => {
    ...
    if (isLastLaneReached) {
        ...
        try {
            ...
            delete chickenRoadActiveSessionsMap[finalQueryUser];
            return res.json({ success: false, message: "🚨 মেগা জ্যাকпот ক্রেডিট এপিআই এরর!" });
        }
    }
...
// 💰 ৪. প্লেয়ারের টাকা তুলে নেওয়ার এপিআই রাউট (CASH OUT API - ওস্তাদ! বানান ১০০% ফিক্সড লক)
